<%@ Page Title="" Language="C#" MasterPageFile="~/app/masterpages/dashboard.master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Xinerji.Dc.Web.app.member.index" %>
<asp:Content ID="xinerjiContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="panel block5">
                ...
                <div class="table-responsive">
                    <table class="table table-hover manage-u-table">
                        ...
                        <tbody>
                            <tr ng-repeat="member in memberList track by $index" id="memberType_{{branch.Id}}">
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-info btn-outline btn-circle btn-lg m-r-5" ng-click="EditView(member);"><i class="ti-pencil-alt"></i></button>
                                </td>
                            </tr>   
                        </tbody>
                    </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content" id="modal-form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <labe><%=pageBundle.GetValue("tc") %></label>
                        <input type="text" class="form-control" placeholder="<%=pageBundle.GetValue("js.warning.tc") %>" ng-model="form.TCIdentifier">      
                    </div>
                    <div class="form-group">
                        <labe><%=pageBundle.GetValue("name") %></label>
                        <input type="text" class="form-control" placeholder="<%=pageBundle.GetValue("js.warning.name") %>" ng-model="form.Name">      
                    </div>
                    <div class="form-group">
                        <labe><%=pageBundle.GetValue("middlename") %></label>
                        <input type="text" class="form-control" placeholder="<%=pageBundle.GetValue("js.warning.middlename") %>" ng-model="form.MiddleName">      
                    </div>
                    <div class="form-group">
                        <labe><%=pageBundle.GetValue("surname") %></label>
                        <input type="text" class="form-control" placeholder="<%=pageBundle.GetValue("js.warning.surname") %>" ng-model="form.Surname">      
                    </div>
                    <div class="form-group">
                        <labe><%=pageBundle.GetValue("email") %></label>
                        <input type="text" class="form-control" placeholder="<%=pageBundle.GetValue("js.warning.email") %>" ng-model="form.Email">      
                    </div>
                    <div class="form-group">
                        <labe><%=pageBundle.GetValue("birthday") %></label>
                        <input type="text" class="form-control mydatepicker" placeholder="dd/mm/yyyy" ng-model="form.Birthdate"> 
                    </div>
                    <div class="form-group">
                        <labe><%=pageBundle.GetValue("company") %></label>
                            <select ng-model="form.CompanyId" required ng-options="option.Id as option.Name for option in companyList" class="form-control">
                                </select>
                    </div>
                    <div class="form-group">
                        <label for="companyPhone"><%=pageBundle.GetValue("phone") %></label>
                        <input type="text" placeholder="" data-mask="(999) 999-9999" class="form-control" ng-model="form.Phone"> <span class="font-13 text-muted">(999) 999-9999</span> 
                    </div>
                    <div class="form-group">
                            <labe><%=pageBundle.GetValue("memberType") %></label>
                         

                            <select ng-model="form.MemberTypeId" required ng-options="option.Id as option.Type for option in memberTypeList" class="form-control">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <span class="font-size:16px;">
                            ...
                            {{form.TCIdentifier}} {{form.Name}} {{form.MiddleName}} {{form.Surname}}
                        </span>
                    </div>           
        ...
        <div class="modal-dialog">
            <div class="modal-content" >
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            <label class="control-label col-md-3"><b><%=pageBundle.GetValue("tc") %> :</b></label>
                            <div class="col-md-9">
                                <p class="form-control-static">  {{form.TCIdentifier}}  </p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3"><b><%=pageBundle.GetValue("middlename") %> :</b></label>
                            <div class="col-md-9">
                                <p class="form-control-static">  {{form.MiddleName}}  </p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3"><b><%=pageBundle.GetValue("surname") %> :</b></label>
                            <div class="col-md-9">
                                <p class="form-control-static">  {{form.Surname}}  </p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3"><b><%=pageBundle.GetValue("birthday") %> :</b></label>
                            <div class="col-md-9">
                                <p class="form-control-static">  {{formatDate(form.Birthdate)}}  </p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3"><b><%=pageBundle.GetValue("company") %> :</b></label>
                            <div class="col-md-9">
                                <p class="form-control-static">  {{findCompanyById(form.CompanyId)}}  </p>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div>
        ...
        <span ng-model="bundle.js.warning.tc" ng-init="bundle.js.warning.tc='<%=pageBundle.GetValue("js.warning.tc") %>'" />
        <span ng-model="bundle.js.warning.middlename" ng-init="bundle.js.warning.middlename='<%=pageBundle.GetValue("js.warning.middlename") %>'" />
        <span ng-model="bundle.js.warning.surname" ng-init="bundle.js.warning.surname='<%=pageBundle.GetValue("js.warning.surname") %>'" />
        <span ng-model="bundle.js.warning.email" ng-init="bundle.js.warning.email='<%=pageBundle.GetValue("js.warning.email") %>'" />
        <span ng-model="bundle.js.warning.company" ng-init="bundle.js.warning.company='<%=pageBundle.GetValue("js.warning.company") %>'" />
        <span ng-model="bundle.js.warning.memberType" ng-init="bundle.js.warning.memberType='<%=pageBundle.GetValue("js.warning.memberType") %>'" />
