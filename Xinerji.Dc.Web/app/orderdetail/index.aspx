    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <%if (trip != null){ %>
                <li><a href="/app/orders/index.aspx?trip_id=<%=trip.Id %>"><%=pageBundle.GetValue("mainTransactionName") %></a></li>
                <%}else {%>
     ...
     <div class="row" ng-show="totalPages != -1">
        <div class="col-md-12">
            <div class="panel block5 panel-info" style="padding:7px;">
                ...
                <h4><%=pageBundle.GetValue("orderCode") %> : <%=order.Title%></h4>
                <h5><%=trip.Truck %> - <%=trip.Company %></h5>
                <%} else{%>
                <h3><%=pageBundle.GetValue("orderCode") %> : <%=order.Title%></h3>
                <%} %>
            </div>
        </div>
    </div>
                   ...
                   <div class="form-group block7">
                        <div class="input-group"> 
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn waves-effect waves-light btn-info" ng-click="SearchProduct();"><i class="fa fa-search" ></i></button>
                            </span>
                        </div>
